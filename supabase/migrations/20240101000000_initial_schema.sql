-- Migration: Create initial database schema for Tito's Barber Shop
-- Tables: barbers, services, customers, appointments, working_hours, blocked_times, vacations, settings
...
-- Barber-Service relationship (many to many)
...
CREATE INDEX idx_blocked_times_barber ON blocked_times(barber_id);
CREATE INDEX idx_vacations_barber ON vacations(barber_id);
